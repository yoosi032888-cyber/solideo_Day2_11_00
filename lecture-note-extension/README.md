...
2. **강의 영상을 먼저 재생** (오디오가 나와야 함)
3. 영상이 재생 중인 상태에서 확장 프로그램 아이콘 클릭
4. **🎙️ 녹음 시작** 클릭
5. 팝업에서 실시간 노트 확인

**주의사항:**
- ⚠️ 영상이 재생되지 않은 상태에서 녹음 시작을 누르면 "오디오가 재생되지 않습니다" 오류가 발생합니다
- ⚠️ 영상을 일시정지하면 녹음이 중단될 수 있습니다
- ⚠️ 탭을 변경하면 녹음이 중단됩니다
...
**가장 흔한 원인:**
- ⚠️ **영상이 재생되지 않음**: 녹음 시작 전에 반드시 영상을 재생해야 합니다
  - 해결: 영상을 재생한 후 다시 시도

**기타 원인:**
- **API 키 확인**: OpenAI API 키가 올바르게 입력되었는지 확인
  - 설정 → OpenAI API 키 확인
- **오디오 재생 확인**: 탭에서 실제로 소리가 나는지 확인
  - 음소거 상태가 아닌지 확인
- **크레딧 확인**: OpenAI 계정에 크레딧이 있는지 확인
  - https://platform.openai.com/account/usage 에서 확인
- **확장 프로그램 재로드**: chrome://extensions/ 에서 확장 프로그램 새로고침
